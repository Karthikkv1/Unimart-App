...
///File Created on 06-06-2024 12:55PM
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        ///Products
        Obx(() => TGridLayout(itemCount: controller.products.length, itemBuilder: (_, index) =>  TProductCardVertical(product: controller.products[index]))), ///Edited on 26-06-2024 2:18PM
      ],
    );
  }
}