///File Created on 21-06-2024 3:25PM
...
import 'package:unimart/features/shop/models/product_variation_model.dart';
...
class VariationController extends GetxController {
  ...
  void onAttributeSelected(ProductModel product, attributeName, attributeValue) {
    ...
    //Show selected variation quantity already in the cart //06-07-2024 9:52AM
  ...
  bool _isSameAttributeValues(Map<String, dynamic> variationAttributes, Map<String, dynamic> selectedAttributes){
    //If selectedAttributes contains 3 attributes and current variation contains 2then return.

    if(variationAttributes.length != selectedAttributes.length) return false;

    //If any of the attributes is different then return example [Green,Large] x [Green, Small]
