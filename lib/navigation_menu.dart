// File created on 26-05-2024 10:50AM
...
import 'package:unimart/utils/helpers/helper_functions.dart'; //26-05-2024 11:02AM
...
class NavigationMenu  extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() => controller.screens[controller.selectedIndex.value]),  //To switch between home,store,wishlist,profile and show detailed information
    );
  }
}
